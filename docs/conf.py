...
extensions = [
    # myst_parser verarbeitet Markdown. Ohne diese Zeile ignoriert Sphinx
    # jede .md-Datei stillschweigend -- die eigene Doku unter docs/eigenbau/
    # waere gebaut, aber unsichtbar. Nachgetragen am 22.08.2026.
    'myst_parser',
    'builder',
    'sphinx.ext.autodoc',
    'sphinx.ext.extlinks',
...
# Welche Dateiendungen als Quelle gelten. Ohne '.md' laesst myst_parser die
# Markdown-Dateien liegen, auch wenn die Erweiterung geladen ist.
source_suffix = {
